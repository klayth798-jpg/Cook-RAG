...
本项目基于all-in-rag项目进行优化，在项目中加入上下文模块和双层记忆模块以及MCP、Skill等，仅供大家学习使用。特别鸣谢：https://github.com/klayth798-jpg/all-in-rag/blob/main/docs/chapter8/01_env_architecture.md
## 项目亮点
